            ...
            <div className="space-y-6">
                ...
                <div className="bg-white dark:bg-slate-800 rounded-lg shadow-md">
                    <div className="p-4 border-b dark:border-slate-700 flex justify-between items-center">
                        ...
                        />
                        <button onClick={openAddModal} className="px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 text-sm whitespace-nowrap"><i className="fa-solid fa-plus me-2"></i>{t('users.add')}</button>
                    </div>
                    ...
                    {loading ? (<div className="p-6 text-center">{t('loading')}...</div>) : (
                        ...
                        <PaginationControls
                            ...
                            filteredRowCount={filteredUsers.length}
                        />
                        </>
                    )}
                </div>
