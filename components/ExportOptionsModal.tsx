        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white dark:bg-slate-800 rounded-lg shadow-xl p-6 w-full max-w-sm text-center">
                <div className="mx-auto flex items-center justify-center h-12 w-12 rounded-full bg-primary-100 dark:bg-primary-900 mb-4">
                    <i className="fa-solid fa-file-export text-2xl text-primary-600 dark:text-primary-400"></i>
                </div>
                ...
                <div className="mt-6 space-y-4">
                    ...
                    >
                        {isPdfExporting ? (
                            <><i className="fa-solid fa-spinner fa-spin"></i> {t('exporting')}</>
                        ) : (
                            <><i className="fa-solid fa-file-pdf"></i> {t('exportOptions.exportAsPdf')}</>
                        )}
                    </button>
                    <button
                        type="button"
                    ...
                    >
                        {isExcelExporting ? (
                            ...
                            <><i className="fa-solid fa-file-excel"></i> {t('exportOptions.exportAsExcel')}</>
                        )}
                    </button>
                </div>
                <div className="mt-6">
